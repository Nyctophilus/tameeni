For Working With Real Time Features:
    ...
    [2] Events That's Sent From Us To Server:
        ...
        # more-info: To Sent Info From User To Server That Contains Each Form Info , We Can Use sendDataToServer(data:any, currentPage:string , nextPage:string) function To Do That!
