const Impacts = () => {
  const boxs = [
    {
      name: "السجل التأميني",
      icon: "/assets/images/impacts/affects-icon1.webp",
    },
    {
      name: "عمر السائق",
      icon: "/assets/images/impacts/affects-icon2.png",
    },
    {
      name: "نوع السيارة",
      icon: "/assets/images/impacts/affects-icon3.webp",
    },
    {
      name: "مدينة القيادة",
      icon: "/assets/images/impacts/affects-icon4.webp",
    },
    {
      name: "الغرض من استخدام السيارة",
      icon: "/assets/images/impacts/affects-icon5.webp",
    },
  ];
