        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          <div className="relative hidden lg:block overflow-hidden rounded-lg sm:h-96 lg:order-last lg:h-full">
            <img
              ...
              src="/assets/images/application-screenshot.png"
          ...
          <div className="lg:py-24 font-medium">
            ...
            <div className="flex gap-5 items-center">
              <img
                src="/assets/images/mob-app/mobile-app-icon1.svg"
                alt="svg"
              />
            ...
            <div className="flex gap-5 items-center">
              <img
                src="/assets/images/mob-app/mobile-app-icon2.svg"
                alt="svg"
              />
              <p className="mt-4 text-gray-600">
            ...
            <div className="flex gap-5 items-center">
              <img
                src="/assets/images/mob-app/mobile-app-icon3.svg"
                alt="svg"
              />
              <p className="mt-4 text-gray-600">
            ...
            <div className="flex gap-5 items-center">
              <img
                src="/assets/images/mob-app/mobile-app-icon4.svg"
                alt="svg"
              />
              <p className="mt-4 text-gray-600">
            ...
            <div className="flex gap-5 items-center">
              <img
                src="/assets/images/mob-app/mobile-app-icon5.svg"
                alt="svg"
              />
              <p className="mt-4 text-gray-600">
