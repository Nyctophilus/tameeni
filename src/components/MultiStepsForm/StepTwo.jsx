...
const StepTwo = () => {
  ...
  const HandleNext = (e) => {
    ...
    res && navigate("/checkout?step=3", { state: { ...state, ...res } });
  };
          ...
          <div className="flex lg-max:flex-col gap-2 justify-between lg:items-center">
            ...
            <div className="flex">
              <span
                ...
                className="grid place-items-center rounded-r-md border px-1 text-gray-800 hover:bg-gray-50 focus:relative"
              >
                ksa
              </span>
              <div className="flex flex-col">
                <span className="inline-flex overflow-hidden border bg-white shadow-sm rounded-tl-md">
                  <span className="w-28 text-center border-e p-3 text-gray-700 hover:bg-gray-50 focus:relative">
                    {`${state?.plate_1.split("-")[1]} ${
                      state?.plate_2.split("-")[1]
                    } ${state?.plate_3.split("-")[1]}`}
                  </span>

                  <span className="w-28 text-center p-3 text-gray-700 hover:bg-gray-50 focus:relativex">
                    {state?.plate_num}
                  </span>
                </span>
                <span className="inline-flex overflow-hidden border bg-white shadow-sm rounded-bl-md">
                  ...
                  <span className="w-28 text-center p-3 text-gray-700 hover:bg-gray-50 focus:relative">
