...
const DropdownInput = ({ filter, selected, setSelected, name, options }) => {
  ...
  return (
    <div className="relative">
      ...
      <div
        className="absolute z-10 mt-2 w-40 rounded-md border border-gray-100 bg-white shadow-lg overflow-hidden transition-[height_opacity] ease-in-out duration-[opacity_550ms_height_500ms]"
        role="menu"
